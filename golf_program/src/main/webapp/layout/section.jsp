...
&nbsp -회원명 선택 시 회원번호는 자동으로 표시<br>
&nbsp -회원번호가 20000 이상인 회원은 수강료 50% 할인<br> 
&nbsp -모든 항목에 유효성 검사를 실시한다(오류메시지, 포커스를 이동)<br>
&nbsp -유효성 검사 통과 시 "수강신청이 정상적으로 완료되었습니다" 띄운 후 메인페이지 이동<br>
5. 회원매출정보조회 프로그램을 작성한다.<br>
6. 강사매출현황 조회하는 프로그램을 작성한다<br>
7. 다시쓰기 버튼은 "정보를 지우고 처음부터 다시 입력합니다" 띄우고 수강월로 포커스 이동<br> 
</p>
</section>
</body>
</html>